          ...
          <div class="ref-link-item ">
            ...
            <div class="ref-link-list">
              ...
              <div v-for="localeOne in $i18n.locales" :key="'locales-ref'+localeOne.code">
                ...
                <label>
                  <input class="current-link" :value="$rest.baseUrl + '/' + localeOne.code + '/ref/' + info.affiliate.link + '/'" type="text"
                         placeholder="..." disabled/>
                  <span @click="copy($rest.baseUrl +  '/' + localeOne.code + '/ref/' + info.affiliate.link + '/')">
                        <img src="~assets/img/copy-documents-option-w.svg" alt/>
                      </span>
                </label>
              </div>
