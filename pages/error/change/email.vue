  ...
  <div class="under-header four-wr" style="min-height:81vh">
    <div class="four four-second">
      <div class="container text-center">
        ...
        <p class="four-second-break">{{ $t("page.exchange.redirect.account_email_error.error") }}</p>
        <p class="four-second-dont-worry">{{ $t("page.exchange.redirect.account_email_error.dont_worry") }}</p>
        <div>
